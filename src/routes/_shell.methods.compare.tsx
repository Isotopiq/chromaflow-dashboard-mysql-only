    ...
    <div className="flex flex-col gap-4 p-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Diff method parameters or compare how a single analyte behaves across columns and methods.
        </p>
      </div>

      <Tabs defaultValue="methods" className="w-full">
        <TabsList>
          <TabsTrigger value="methods">Method diff</TabsTrigger>
          <TabsTrigger value="analyte">Analyte across runs</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="analyte" className="mt-4">
          <AnalyteComparePanel />
        </TabsContent>
      </Tabs>
    </div>
